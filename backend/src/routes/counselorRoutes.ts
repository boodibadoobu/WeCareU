...
import { getCounselors, getSessionRequests, approveSession, rejectSession, completeSession, getCounselorActivity, getCounselorStats } from '../controllers/counselorController';
...
router.post('/requests/:id/complete', authenticateToken, requireRole(['COUNSELOR']), completeSession);
